            ...
            <div class="container-login100">
                <div class="wrap-login100">
                    ...
                    <form class="login100-form validate-form" runat="server">
                        <span class="login100-form-title">Üye Girişi
                        </span>
                        ...
                        <div class="wrap-input100 validate-input" data-validate="Password is required">
                           <asp:TextBox ID="TxtSifre" class="input100" runat="server" placeholder="Şifre" TextMode="Password" ></asp:TextBox>
                            <span class="focus-input100"></span>
                            <span class="symbol-input100">
                        ...
                        <div class="text-center p-t-12">
                            <span class="txt1">Şİfremi 
                            </span>
                            <a class="txt2" href="SifremiUnuttum.aspx">Unuttum?
                            </a>
                        </div>
