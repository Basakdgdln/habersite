<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="GelenKutusu.aspx.cs" Inherits="GelenKutusu" %>
                                        ...
                                        <asp:Repeater ID="Repeater1" runat="server">
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%#"~/OnaylananMesajlar.aspx?MESAJID="+Eval("MESAJID") %>' CssClass="btn btn-success">Onayla</asp:HyperLink>&nbsp;
                                                                  <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl='<%#"~/OnaylanmayanMesajlar.aspx?MESAJID="+ Eval("MESAJID") %>' CssClass="btn btn-danger">Reddet</asp:HyperLink>&nbsp;
                                                                  <asp:HyperLink ID="HyperLink3" runat="server" NavigateUrl='<%#"~/CöpKutusu.aspx?MESAJID="+ Eval("MESAJID") %>' CssClass="btn btn-primary">Sil</asp:HyperLink>&nbsp;
                                                    </td>
                                                </tr>
                                            </ItemTemplate>
                                        </asp:Repeater>
