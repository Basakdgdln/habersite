...
public partial class OnaylananMesajlar : System.Web.UI.Page
{
    ...
    {
        DataSetTableAdapters.TBL_GELENKUTUSUTableAdapter onay = new DataSetTableAdapters.TBL_GELENKUTUSUTableAdapter();
        Repeater1.DataSource = onay.OnaylananMesajlar();
        Repeater1.DataBind();
