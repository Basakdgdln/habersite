<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="OnaylananMesajlar.aspx.cs" Inherits="OnaylananMesajlar" %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <div class="card card-primary card-outline">
                                <div class="card-header">
                                    <h3 class="card-title">Onaylanan Mesajlar </h3>
                                </div>
                                <!-- /.card-header -->
