<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="OnaylanmayanMesajlar.aspx.cs" Inherits="OnaylanmayanMesajlar" %>
                    ...
                    <div class="row">
                                    ...
                                    <ul class="nav nav-pills flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a href="OnaylananMesajlar.aspx" class="nav-link">
                                                <i class="far fa-envelope"></i>Onaylanan Mesajlar
                                        ...
                                        <li class="nav-item">
                                            <a href="OnaylanmayanMesajlar.aspx" class="nav-link">
                                                <i class="fas fa-exclamation-circle"></i>Onaylanmayan Mesajlar
                        ...
                        <div class="col-md-9">
                            <div class="card card-primary card-outline">
                                <div class="card-header">
                                    <h3 class="card-title">Onaylanmayan Mesajlar </h3>
                                </div>
                                <!-- /.card-header -->
                                            ...
                                            <asp:Repeater ID="Repeater1" runat="server">
                                                <ItemTemplate>
                                                    <tr>
                                                        ...
                                                        <td class="mailbox-subject"><b><%#Eval("KONU") %></b> - <%#Eval("MESAJ")%>... </td>
